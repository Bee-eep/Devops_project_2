resource "aws_security_group" "devops_project_1_node_sg" {
  name        = "devops-project-1-node-sg"
...
resource "aws_instance" "my_ec2_instance2" {
  ...
  vpc_security_group_ids = [aws_security_group.devops_project_1_node_sg.id]
  key_name               = "My_Key"
